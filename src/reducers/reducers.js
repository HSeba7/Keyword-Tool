...
import { SET_DATA, SET_KEYWORDS, SET_VALUME, SET_KEYWORD_VALUME_PAYLOAD, SET_VALUME_OTHER_PAYLOAD, IS_SUBMIT, SET_POSITIVE_KEYWORDS, SET_NEGATIVE_KEYWORDS, SET_FILTERING_TEXT } from '../actions/actions.js';
...
const volumeReducer = (state = {valumeData: [], keywordValumeData: [], valumeOtherData: [], isSubmit: false}, action) => {
  switch (action.type) {
    case SET_VALUME:
